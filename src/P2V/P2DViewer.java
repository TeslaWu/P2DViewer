...
public class P2DViewer
{
    ...
    /**
     ...
     The rotation angle of the P2DViewer.
     */
    protected static Variable spin;
    /**
    ...
    /**
     * Moves the viewer's rotation angle to the specified value relative to its current blue value using animation.
     *
     * @param value the relative value of rotation angle
     * @throws Exception if an error occurs during the move
     */
    public static void toMoveSpinRelatively(float value) throws Exception {
        spin.toMoveValueRelatively(value);
    }

    /**
     * Moves the viewer's rotation angle to the specified value using animation.
     *
     * @param value the value of rotation angle
     * @throws Exception if an error occurs during the move
     */
    public static void toMoveSpin(float value) throws Exception {
    ...
    /**
     * Returns the current rotation angle of the viewer.
     *
     * @return the rotation angle of the viewer as a Variable object
     */
    public static Variable getSpin() {
        return spin;
    }

    /**
     * Sets the rotation angle of the viewer.
     *
     * @param spin the rotation angle as a Variable object
     */
    public static void setSpin(Variable spin) {
        P2DViewer.spin = spin;
    }
